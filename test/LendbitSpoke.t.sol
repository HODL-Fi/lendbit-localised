...
contract LendbitSpokeTest is Base {
    ...
    function testOnReport_RepayCreation() public {
        // The forwarder address used in setUp
        address forwarder = 0x15fC6ae953E024d975e77382eEeC56A9101f9F88;

        bytes memory metadata =
            hex"111111111111111111111111111111111111111111111111111111111111111131653834343762643462aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa0001";

        bytes memory report =
            hex"";

        // Call onReport as the forwarder
        vm.prank(forwarder);
        lendbitSpoke.onReport(metadata, report);
    }
